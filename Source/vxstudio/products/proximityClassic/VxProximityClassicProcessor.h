...
#include "dsp/VxProximityClassicDsp.h"

class VXProximityClassicAudioProcessor final : public vxsuite::ProcessorBase {
public:
    VXProximityClassicAudioProcessor();
    ~VXProximityClassicAudioProcessor() override = default;
...
private:
    ...
    vxsuite::ProximityClassic::ProximityClassicDsp proximityDsp;
