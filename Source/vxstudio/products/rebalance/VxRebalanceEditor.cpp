...
public:
    ...
    void paint(juce::Graphics& g) override {
        ...
        const juce::String aiState = aiSnapshot.available
            ? (aiSnapshot.hasFrame ? "AI Mask" : "AI Waiting")
            : "AI Standby";
        auto aiText = aiState
            + "  Conf " + juce::String(aiSnapshot.latestConfidence * 100.0f, 0) + "%"
...
VXRebalanceEditor::VXRebalanceEditor(VXRebalanceAudioProcessor& processorToUse)
    ...
    aiModeBox.addItem("Classic", 1);
    aiModeBox.addItem("AI Assist", 2);
    aiModeBox.addItem("AI Strong", 3);
