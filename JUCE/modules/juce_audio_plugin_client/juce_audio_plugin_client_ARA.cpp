...
#if __has_include(<ARA_Library/Utilities/ARAChannelArrangement.cpp>)
 #include <ARA_Library/Utilities/ARAChannelArrangement.cpp>
#elif __has_include(<ARA_Library/Utilities/ARAChannelFormat.cpp>)
 #include <ARA_Library/Utilities/ARAChannelFormat.cpp>
#else
 #error "Missing ARA channel utility source (expected ARAChannelArrangement.cpp or ARAChannelFormat.cpp)"
#endif
