...
#   products/deverb/dsp/          → used by VXDeverb + VXRepair + VXProximity (dryness stage)
...
# deverb/dsp/ changes additionally require rebuilding + re-testing VXProximity
# (VxProximityProcessor.cpp owns a SpectralProcessor instance for its dryness stage).
